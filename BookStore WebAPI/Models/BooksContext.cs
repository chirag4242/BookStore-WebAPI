...
public partial class BooksContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=Books");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Author>(entity =>
        {
            entity.HasKey(e => e.AuthorId).HasName("PK__Author__86516BCFF9E2BD2F");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__490D1AE1BF646399");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__Job__6E32B6A53CD6077F");
        ...
        {
            entity.HasKey(e => e.PubId).HasName("PK__Publishe__2515F2222A094BC9");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CC0481F414");
